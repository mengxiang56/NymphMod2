...
public sealed class NymphNothingToSay : ModCardTemplate
{
    ...
    [
        HoverTipFactory.FromPower<NoThoughtGainPower>()
    ];

    public NymphNothingToSay()
        : base(
            1,
            CardType.Attack,
            CardRarity.Common,
        ...
        CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<NoThoughtGainPower>(
            choiceContext,
            Owner.Creature,
            1,
            Owner.Creature,
