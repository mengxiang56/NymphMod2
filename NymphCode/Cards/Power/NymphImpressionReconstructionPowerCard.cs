...
public sealed class NymphImpressionReconstructionPowerCard : ModCardTemplate
{
    ...
    public NymphImpressionReconstructionPowerCard()
    ...
    protected override async Task OnPlay(
        ...
        CardPlay cardPlay)
    {
        await PowerCmd.Apply<ImpressionReconstructionPower>(
            choiceContext,
            Owner.Creature,
